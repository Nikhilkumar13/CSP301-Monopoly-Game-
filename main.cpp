 ...
 *  To  Compile game  run the following Command
 * Go into project directory and type "cmake ./"
 * then type "make"  this will generate the executables Game
